...
<body>
      ...
      <div class="t1">
        ...
        <div class="mb-3">
               ...
               <h5> Don't have an account? <a href="register here.php">Register here</a></h5>
         </form>
         </div>
...
if (isset($_GET['t1']) && isset($_GET['t2'])) {
    ...
    $q = "SELECT * FROM donarlogin WHERE DonorEmail='$a' AND password='$b'";
    $rs = mysqli_query($con, $q);

    if ($row = mysqli_fetch_array($rs)) {
       
        $_SESSION['u'] = $row['DonorName'];
        $h= $row['DonorName'];
