...
<body>
      ...
      <div class="t1">
        ...
        <div class="box">   
                 <h1> Patient Register Page</h1><hr>
        ...
        <div class="mb-3">
                ...
                <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="t3">
        </div>
        <div class="mb-3">
                <label for="mob" class="form-label">Mobile:</label>
                <input type="tel" class="form-control" id="tel" placeholder="Enter Mobile number" name="t4">
        </div>
        <div class="mb-3">
...
<?php
        ...
        if(isset($_GET['t1'])){
            ...
            $d=$_GET['t4'];
               ...
               $q="insert into patient values(NULL,'$a','$b','$c','$d')";
